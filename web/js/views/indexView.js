...
const INTROS = {
  ...
  '000015': { intro: '从上证180成分股中选取50只股息率最高的股票，沪市视角的红利基准（股息率约5.9%）。', note: '样本空间仅限上证180，银行权重较高，风格偏沪市大盘，与全市场红利有差异。' },
  ...
  '980092': { intro: '国证自由现金流指数（国证指数公司编制）：剔除成交额后20%、金融/房地产行业及近12季度ROE稳定性后10%的证券，选取近一年自由现金流率最高的100只构成；季度调样、单只权重上限10%（调整后自由流通市值加权）。', note: '与932368区分：159229实际跟踪的是中证800自由现金流（932368），并非本指数，本指数无跟踪ETF；官网仅披露前十大权重（约54%），其余90只权重未公开；行业口径为国证分类（工业/可选消费/能源为主），与申万口径不同；历史行情数据源为国证官网（2012年起）。' },
